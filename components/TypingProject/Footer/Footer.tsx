  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/thamjidthachu"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/thamjid-mannarayil/"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/thamjid_thachu/"}
            Icon={InstagramIcon}
          />
          <ClickableIcon
            href={"https://www.youtube.com/watch?v=UjWowY51nKA"}
            Icon={YoutubeIcon}
          />
        </div>
    ...
    text-sm  space-y-2  "
          >
            ...
            <span className="text-xs flex flex-row items-center space-x-2 group-hover:text-AAsecondary">
              ...
              />
              <span className="">Powered By - @thachuthamjid</span>
            </span>
          </div>
        </a>
      </div>
