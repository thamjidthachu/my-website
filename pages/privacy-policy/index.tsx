    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          ...
          <p className="text-sm text-gray-900 mb-8">Effective Date: 01 Sep 2025</p>

          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">1. Google Analytics</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">2. Portfolio and Projects</h2>
            <p className="text-gray-900 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">3. No Personal Data Collection</h2>
            <p className="text-gray-900 mb-4">
          ...
          <section>
            ...
            <p className="text-gray-900 mt-2">
              Email: <a href="mailto:thachuthamjid@gmail.com" className="text-blue-600 hover:text-blue-800 transition duration-300">thachuthamjid@gmail.com</a>
            </p>
          </section>
        </div>
      </div>
